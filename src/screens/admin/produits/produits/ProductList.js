...
const ProductList = ({ navigation }) => {
  ...
  const checkImageExists = async (imagePath) => {
    ...
    try {
      ...
      console.log(`Vérification image: ${imagePath}`);
      console.log(`Existe: ${fileInfo.exists}, Taille: ${fileInfo.size} bytes`);
            ...
            >
              <View style={styles.productImageContainer}>
                {product.localImagePath ? (
                  <TouchableOpacity
                    onPress={() => checkImageExists(product.localImagePath)}
                  >
                    <Image
                      ...
                      onError={(e) => {
                        ...
                        console.log("URI:", product.localImagePath);
                      }}
                    />
                  </TouchableOpacity>
                ) : product.imageUrl ? (
