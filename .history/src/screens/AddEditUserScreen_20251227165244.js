...
export default function AddEditUserScreen({ route, navigation }) {
 ...
 // Dans la fonction handleSubmit, modifiez la création de userData :
const handleSubmit = async () => {
  ...
  try {
    ...
    const userData = {
      ...
      // Ajoutez cette ligne pour convertir les booléens si nécessaire
      actif: true, // Par défaut à true pour un nouvel utilisateur
      // Si vous avez un champ dateNaissance, formattez-le
      dateNaissance: formData.dateNaissance || null
    };

    // Retirez les propriétés qui ne doivent pas être dans Firestore
    delete userData.id; // Si présent
