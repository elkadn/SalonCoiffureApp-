...
const loadSpecialites = async () => {
  try {
    ...
    const activeSpecialites = data.filter(specialite => specialite.actif !== false);
      ...
      >
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            Gérez ici les spécialités des coiffeurs. Chaque spécialité doit avoir un nom unique.
          </Text>
        </View>
