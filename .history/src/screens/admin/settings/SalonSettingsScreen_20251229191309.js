  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        >
          <FontAwesome name="arrow-back" size={24} color="#333" />
        </TouchableOpacity>
            ...
            {formData.logoPath ? (
              <View style={styles.logoContainer}>
                ...
                <View style={styles.logoActions}>
                  ...
                  >
                    <FontAwesome name="edit" size={20} color="#2196F3" />
                  ...
                  >
                    <FontAwesome name="delete" size={20} color="#F44336" />
              ...
              <TouchableOpacity
                ...
                onPress={handleSelectLogo}
              >
                <FontAwesome name="add-a-photo" size={40} color="#ccc" />
