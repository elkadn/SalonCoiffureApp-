...
const CoiffeurManagement = ({ navigation }) => {
  const menuItems = [
    ...
    {
      title: "Ajouter un Styliste",
      description: "Créer un nouveau profil de styliste",
      screen: "AddStyliste", // À créer si nécessaire
      icon: "person-add",
      color: "#FF9800",
    },
    {
      ...
      screen: "StylisteList", // Redirige vers la liste des stylistes
      icon: "assignment",
      color: "#E91E63",
    },
  ];
