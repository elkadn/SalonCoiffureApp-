        ...
        {filteredProducts.length === 0 ? (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>
              {searchText || filterLowStock ? "Aucun produit trouvé" : "Aucun produit enregistré"}
            </Text>
      ...
      <Icon name="image" size={30} color="#ccc" />
              ...
              <View style={styles.productInfo}>
                <View style={styles.productHeader}>
                  ...
                  <Text style={styles.productCode}>{product.code || "Sans code"}</Text>
                </View>
                
                <View style={styles.productDetails}>
                  <Text style={styles.productCategory}>{product.categorieNom}</Text>
                  <Text style={styles.productSupplier}>{product.fournisseurNom}</Text>
                </View>
                ...
                <View style={styles.productFooter}>
                  <View style={styles.stockContainer}>
                    <View style={[
                      styles.stockBadge,
                      { backgroundColor: getStockStatusColor(product.quantite, product.seuilAlerte) }
                    ]}>
                      <Text style={styles.stockText}>
                        {getStockStatusText(product.quantite, product.seuilAlerte)}
                      </Text>
                    </View>
