    ...
    try {
      ...
      if (user) {
        setFormData({
          ...
          password: "",
          // AJOUTE cette ligne :
          actif: user.actif === undefined ? true : user.actif, // Prendre la valeur exacte
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const userData = {
        ...
        role: formData.role,
        actif: formData.actif, // AJOUTE cette ligne
      ...
      <ScrollView style={styles.content}>
        <View style={styles.formContainer}>
          ...
          {isEditing && (
            ...
            >
              <Icon
                name={formData.actif ? "toggle-off" : "toggle-on"}
                size={20}
                color="#fff"
              />
...
const styles = StyleSheet.create({
  ...
  deactivateButton: {
    backgroundColor: "#F44336", // Rouge pour désactiver
  },
  activateButton: {
