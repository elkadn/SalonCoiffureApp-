  ...
  const renderSelectField = (label, field, options) => {
    ...
    return (
      <View style={styles.formGroup}>
        ...
        >
          <Text style={[styles.selectText, !fieldValue && styles.placeholderText]}>
            {displayValue}
          </Text>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Sélectionner {modalTitle.toLowerCase()}</Text>
            ...
            <ScrollView>
              {modalOptions.map((option) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.modalOption,
                    formData[activeModal] === option && styles.modalOptionSelected
                  ]}
                  onPress={() => selectOption(option)}
                >
                  <Text style={[
                    styles.modalOptionText,
                    formData[activeModal] === option && styles.modalOptionTextSelected
                  ]}>
                    {option}
                  </Text>
