    ...
    >
      <View style={styles.userInfo}>
        ...
        <View style={styles.userMeta}>
          ...
          {item.role === 'client' && item.pointsFidelite !== undefined && (
            <Text style={styles.specificInfo}>🎯 {item.pointsFidelite} points</Text>
          )}

          <View style={styles.actions}>
      {/* Bouton profil capillaire pour les clients */}
      {item.role === 'client' && (
        <TouchableOpacity
          style={styles.actionButton}
          onPress={() => navigation.navigate('ProfilCapillaire', { 
            clientId: item.id, 
        ...
        >
          ...
          {item.role === 'styliste' && item.experience !== undefined && (
            <Text style={styles.specificInfo}>📅 {item.experience} ans exp.</Text>
          )}
      ...
      <View style={styles.actions}>
        {item.role === 'styliste' && (
          <TouchableOpacity
            style={styles.actionButton}
            onPress={() => navigation.navigate('StylisteCreneaux', { stylisteId: item.id, stylisteName: `${item.prenom} ${item.nom}` })}
          >
    ...
    <View style={styles.container}>
      ...
      <View style={styles.filterContainer}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.roleFilter}>
          ...
          <TouchableOpacity
            style={[styles.roleButton, selectedRole === 'styliste' && styles.roleButtonActive]}
            onPress={() => setSelectedRole('styliste')}
          >
            <Text style={[styles.roleButtonText, selectedRole === 'styliste' && styles.roleButtonTextActive]}>
              ✂️ Stylistes
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[styles.roleButton, selectedRole === 'assistante' && styles.roleButtonActive]}
            onPress={() => setSelectedRole('assistante')}
          >
            <Text style={[styles.roleButtonText, selectedRole === 'assistante' && styles.roleButtonTextActive]}>
              💼 Assistantes
            </Text>
          </TouchableOpacity>
        </ScrollView>
