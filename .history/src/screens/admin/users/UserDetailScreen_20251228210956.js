...
{user.role === 'client' && (
  <View style={styles.section}>
    ...
    >
      <Icon name="content-cut" size={24} color="#4CAF50" style={styles.profilIcon} />
      <View style={styles.profilContent}>
        <Text style={styles.profilTitle}>Gérer le profil capillaire</Text>
        <Text style={styles.profilDescription}>Informations sur les cheveux, traitements, etc.</Text>
      </View>
      <Icon name="chevron-right" size={24} color="#666" />
    </TouchableOpacity>
  </View>
