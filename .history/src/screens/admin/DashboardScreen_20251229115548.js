...
const DashboardScreen = ({ navigation, route }) => {
  ...
  const menuItems = [
    ...
    // Dans DashboardScreen.js, modifiez l'item "Gestion des Coiffeurs" :
    {
      title: "💇 Gestion des Coiffeurs",
      description: "Gérer les coiffeurs et leurs spécialités",
      screen: "CoiffeurManagement", // Changé de "Coiffeurs" à "CoiffeurManagement"
      icon: "💇",
      color: "#2196F3",
    },
    {
      ...
      screen: "ProductManagement", // Nouvelle page
      icon: "📦",
      color: "#673AB7", // Couleur violette pour différencier
    },
    {
