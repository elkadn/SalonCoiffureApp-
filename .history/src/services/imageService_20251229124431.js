// services/imageService.js - Version corrigée
...
export const uploadImage = async (uri, productId) => {
  try {
    ...
    // Si l'upload échoue, vous pouvez retourner null ou l'URI locale
    // Pour permettre la création du produit sans image
    return null;
  }
};