...
export const changeUserPassword = async (userId, newPassword) => {
  try {
    ...
    // Note: Dans Firebase, l'admin peut changer le mot de passe via l'API Admin SDK
    // Pour React Native, on utilisera une Cloud Function ou on mettra à jour
    // via l'interface Firebase Console

    // Pour l'instant, retourner un message
    console.log(
      "Note: Utilisez Firebase Console ou Cloud Functions pour changer le mot de passe"
    );
    return true;
  } catch (error) {
