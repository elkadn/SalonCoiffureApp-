...
// Créez un composant CustomHeader séparé
export const CustomHeader = ({ navigation, route }) => {
  ...
  return (
    <View style={headerStyles.container}>
      <TouchableOpacity 
        style={headerStyles.drawerButton} 
        onPress={() => navigation.toggleDrawer ? navigation.toggleDrawer() : navigation.openDrawer()}
      >
        <Text style={headerStyles.drawerButtonIcon}>☰</Text>
      </TouchableOpacity>
      
      <Text style={headerStyles.title}>{route.name}</Text>
