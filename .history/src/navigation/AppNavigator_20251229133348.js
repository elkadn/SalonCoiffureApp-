...
// // Screens
// import SplashScreen from "../screens/auth/SplashScreen";
// import DrawerNavigator from "./DrawerNavigator"; // Import du Drawer
...
// Screens
import SplashScreen from "../screens/auth/SplashScreen";
import HomeScreen from "../screens/HomeScreen"; // Nouvel écran d'accueil
import LoginScreen from "../screens/auth/LoginScreen";
import DashboardScreen from "../screens/admin/DashboardScreen";
// ... importez tous vos autres écrans
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Splash">
        ...
        {/* Admin Screens (seulement si connecté en tant qu'admin) */}
        {user?.role === 'admin' ? (
          <>
            <Stack.Screen
              name="Dashboard"
